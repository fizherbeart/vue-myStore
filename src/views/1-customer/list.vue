<template>
    <div v-show="list.length">
        <div class="list-control">
            <div class="list-control-query">
                <el-row>
                    <el-col :span="12">
                        <el-input v-model="query" placeholder="请输入内容">
                            <el-button slot="append" icon="el-icon-search"></el-button>
                            <!-- @click="handleFilterQuery(query)" -->
                        </el-input>
                    </el-col>
                </el-row>
            </div>
...
<script>
import Product from '@/views/1-customer/product.vue';
export default {
    components: { Product },
    computed: {
        list() {
        ...
        filteredAndOrderedList() {
            ...
            if (this.query !== '') {
                list = list.filter(item => {
                    return item.name.search(new RegExp(this.query, 'i')) != -1;
                })
            }
            return list;
        }
